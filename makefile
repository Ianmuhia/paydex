...
profile:
	...
	go tool pprof -http=:5001 192.168.0.103:8090/debug/pprof/profile?seconds=120


heap:
	 @read -p "Server Port to profile ? : " Port; \
	go tool pprof -http=:5001 192.168.0.103:8090/debug/pprof/heap?seconds=120
...
binary:
	go build -v -ldflags="-X 'main.version=`git describe --tags --abbrev=0`'" -o ./tmp/main ./cmd/ 
...
mock-user:
	mockgen -source=ratings.go --destination=./mocks/ratings.go RatingsService
